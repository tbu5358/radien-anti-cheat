...
exports.sanitizedConsole = void 0;
exports.sanitizeUserId = sanitizeUserId;
exports.sanitizeChannelId = sanitizeChannelId;
exports.sanitizeGuildId = sanitizeGuildId;
exports.sanitizeRoleId = sanitizeRoleId;
exports.sanitizeDiscordId = sanitizeDiscordId;
exports.sanitizeEmail = sanitizeEmail;
exports.sanitizeUrl = sanitizeUrl;
exports.sanitizeIpAddress = sanitizeIpAddress;
exports.sanitizeString = sanitizeString;
exports.sanitizeStringSelective = sanitizeStringSelective;
exports.sanitizeObject = sanitizeObject;
exports.sanitizeAuditMetadata = sanitizeAuditMetadata;
exports.sanitizeLogArgs = sanitizeLogArgs;
exports.updateSanitizationConfig = updateSanitizationConfig;
exports.getSanitizationConfig = getSanitizationConfig;
exports.withUnsanitizedLogging = withUnsanitizedLogging;
/**
...
function sanitizeUserId(userId) {
    if (!DEFAULT_CONFIG.enabled)
        return userId;
    if (!DEFAULT_CONFIG.preservePartialIds)
 ...
 */
function sanitizeStringSelective(value) {
    if (!DEFAULT_CONFIG.enabled)
        return value;
    if (typeof value !== 'string')
        return String(value);
 ...
 */
function sanitizeObject(obj, maxDepth = 3, visited = new WeakSet()) {
    if (!DEFAULT_CONFIG.enabled)
        return obj;
    if (maxDepth <= 0)
 ...
 */
function sanitizeField(key, value, depth, visited = new WeakSet()) {
    const lowerKey = key.toLowerCase();
 ...
 */
function updateSanitizationConfig(config) {
 ...
 */
async function withUnsanitizedLogging(callback) {
 ...
 */
exports.sanitizedConsole = {
    log: (...args) => console.log(...sanitizeLogArgs(...args)),
    warn: (...args) => console.warn(...sanitizeLogArgs(...args)),
    error: (...args) => console.error(...sanitizeLogArgs(...args)),
    info: (...args) => console.info(...sanitizeLogArgs(...args)),
    debug: (...args) => console.debug(...sanitizeLogArgs(...args)),
};
